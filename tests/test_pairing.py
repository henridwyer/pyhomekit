from pyhomekit.pairing import H, N, g
...
a_hex = """60975527 035CF2AD 1989806F 0407210B C81EDC04 E2762A56 AFD529DD DA2D4393"""

A_hex = """FAB6F5D2 615D1E32 3512E799 1CC37443 F487DA60 4CA8C923 0FCB04E5 41DCE628
...
b_hex = """E487CB59 D31AC550 471E81F0 0F6928E0 1DDA08E9 74A004F4 9E61F5D1 05284D20"""

B_hex = """40F57088 A482D4C7 733384FE 0D301FDD CA9080AD 7D4F6FDF 09A01006 C3CB6D56
...
s_hex = """BEB25379 D1A8581E B5A72767 3A2441EE"""
...
u_hex = """03AE5F3C 3FA9EFF1 A50D7DBB 8D2F60A1 EA66EA71 2D50AE97 6EE34641 A1CD0E51
       C4683DA3 83E8595D 6CB56A15 D5FBC754 3E07FBDD D316217E 01A391A1 8EF06DFF"""

S_hex = """ F1036FEC D017C823 9C0D5AF7 E0FCF0D4 08B009E3 6411618A 60B23AAB BFC38339
...
K_hex = """5CBC219D B052138E E1148C71 CD449896 3D682549 CE91CA24 F098468F 06015BEB
           6AF245C2 093F98C3 651BCA83 AB8CAB2B 580BBF02 184FEFDF 26142F73 DF95AC50"""


def hex_to_int(hex_str: str) -> int:
    return int(''.join(hex_str.split()), 16)
