...
# -*- coding: utf-8 -*-
#
# pyHomeKit documentation build configuration file, created by
# sphinx-quickstart on Sun Jul 23 19:47:48 2017.
#
...
htmlhelp_basename = 'pyHomeKitdoc'
...
man_pages = [(master_doc, 'pyhomekit', 'pyHomeKit Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'pyHomeKit', 'pyHomeKit Documentation', author, 'pyHomeKit',
     'HomeKit for Python', 'bluetooth'),
]
